# tiktok-search-api Specification

## Purpose

Expose server-side TikTok search for vkara when experiments are enabled, using a shared Playwright browser pool and validated HTTP contracts.
